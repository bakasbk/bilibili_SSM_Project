...
public class SmsSample {
	...
	public String sendMessage(String phone,int code) {
		String testPhone = phone;
		String testContent = "您的验证码是"+code+",５分钟内有效。若非本人操作请忽略此消息。"; // 注意测试时，也请带上公司简称或网站签名，发送正规内容短信。千万不要发送无意义的内容：例如 测一下、您好。否则可能会收不到
